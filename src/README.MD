...
> Rozszerzenie: [Architektura](docs/GLX_ARCHITEKTURA_KATALOG.md), [BUS](docs/12_mosaic_metrics.md), [EGDB](docs/egdb.md).
...
Dalsze formalizmy (Φ/Ψ, reguły Δ, dowody): [GLX_Mosaika_Matematyka_v5.md](docs/GLX_Mosaika_Matematyka_v5.md), [12_mosaic_metrics.md](docs/12_mosaic_metrics.md).
...
Szczegóły: [validacja](docs/validation.md), [egdb](docs/egdb.md).
...
Więcej: [katalog](docs/index.md), [repozytorium](repo.md), [gui](gui.md).
...
* **[Architektura](docs/GlitchLab_Arch_v5.md)**
* **[Katalog systemu](docs/GLX_ARCHITEKTURA_KATALOG.md)**
* **[BUS](docs/bus.md)**
* **[EGDB + EGQL](docs/egdb.md)**
* **[Walidacja](docs/validation.md)**
* **[Mozaika/metryki](docs/12_mosaic_metrics.md)**
* **[GUI](docs/gui.md)**
...
* **[Kontrakty danych](docs/contracts.md)**
* **[Walidacja](docs/validation.md)**
* **[Metryki i wizualizacje](docs/12_mosaic_metrics.md)**
