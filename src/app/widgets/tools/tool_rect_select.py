# glitchlab/app/widgets/tools/tool_rect_select.py
# -*- coding: utf-8 -*-
"""
...
Wymaga:
- glitchlab.app.widgets.overlay_renderer.OverlayRenderer
- glitchlab.app.widgets.tools.base.ToolBase / ToolEventContext
"""
...
# ── Overlay utils ────────────────────────────────────────────────────────────
try:
    from glitchlab.app.widgets.overlay_renderer import OverlayRenderer, OverlayStyle
...
try:
    from glitchlab.app.widgets.tools.base import ToolBase, ToolEventContext  # type: ignore
except Exception:  # pragma: no cover
