...
try:  # preferowana ścieżka (v4)
    from glitchlab.app.views.hud import HUDView as Hud  # type: ignore[F401]
    warnings.warn(
        "glitchlab.app.widgets.hud is deprecated; use glitchlab.app.views.hud.HUDView",
        DeprecationWarning,
        stacklevel=2,
    )
except Exception:
        ...
        def __init__(self, master: tk.Misc):
            ...
            ttk.Label(
                ...
                text="(HUD unavailable — fallback stub)\n"
                     "Install/enable glitchlab.app.views.hud.HUDView",
                foreground="#777",
                justify="center",
