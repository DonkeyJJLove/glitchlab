...
version: 3
kind: module
id: "app-views-notebook"
created_at: "2025-09-13"
name: "glitchlab.app.views.notebook"
author: "GlitchLab v3"
...
depends_on: ["tkinter/ttk","typing","glitchlab.app.panel_loader?"]
used_by: ["glitchlab.app.app_shell","glitchlab.app.app (legacy)","glitchlab.app.views.menu"]
policy:
  deterministic: true
  ui_thread_only: true
constraints:
...
---
"""
# glitchlab/app/views/notebook.py
...
try:
    ...
    from glitchlab.app.panel_loader import get_panel_class  # type: ignore
except Exception:
