# glitchlab/app/views/bottom_panel.py
# -*- coding: utf-8 -*-
...
# ─────────────────────────────────────────────────────────────────────────────
try:
    from glitchlab.app.views.hud import HUDView as Hud
except Exception:  # pragma: no cover
    Hud = None  # type: ignore

try:
    from glitchlab.app.widgets.graph_view import GraphView
except Exception:  # pragma: no cover
    GraphView = None  # type: ignore

try:
    from glitchlab.app.widgets.mosaic_view import MosaicMini
except Exception:  # pragma: no cover
    MosaicMini = None  # type: ignore

try:
    from glitchlab.app.widgets.diag_console import DiagConsole
except Exception:  # pragma: no cover
