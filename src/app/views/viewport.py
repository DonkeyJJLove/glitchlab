# glitchlab/app/views/viewport.py
# -*- coding: utf-8 -*-
"""
...
try:
    from glitchlab.app.widgets.image_canvas import ImageCanvas  # nasz canvas z narzędziami
except Exception:  # pragma: no cover
    ImageCanvas = None  # type: ignore

try:
    from glitchlab.app.widgets.image_canvas import ImageToolbar  # właściwy toolbar (plik 2)
except Exception:  # pragma: no cover
