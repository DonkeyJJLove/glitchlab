...
# styles
try:
    from glitchlab.app.views.bottom_area import init_styles
except Exception:
...
# GUI bits
from glitchlab.app.views.tab_general import GeneralTab, GeneralTabConfig
from glitchlab.app.views.tab_filter import TabFilter, FilterTabConfig
from glitchlab.app.views.tab_preset import PresetsTab
from glitchlab.app.widgets.canvas_container import CanvasContainer
from glitchlab.app.views.menu import MenuBar
from glitchlab.app.views.left_dummy import LeftDummy
...
try:
    from glitchlab.app.views.helpers.dragging_helper import FloatingLayoutManager
except Exception:
    FloatingLayoutManager = None  # type: ignore

# services / fallbacks
try:
    from glitchlab.app.event_bus import EventBus
...
try:
    from glitchlab.app.services.pipeline_runner import PipelineRunner
except Exception:
    PipelineRunner = None  # type: ignore

try:
    from glitchlab.app.views.bottom_area import BottomArea
except Exception:
    BottomArea = None  # type: ignore

try:
    from glitchlab.app.services.image_history import ImageHistory
except Exception:
    ImageHistory = None  # type: ignore

try:
    from glitchlab.app.services.layer_manager import LayerManager
except Exception:
