...
"""
GLX-CTX:v1
component: gui.services.pipeline_runner
role: async pipeline runner with GUI progress signals

# MOSAIC::PROFILE (S/H/Z)
S: threading.Thread,threading.Lock
H: core.pipeline.apply_pipeline,gui.event_bus.EventBus.publish
Z: 1

# AST::SURFACE
imports: glitchlab.core.pipeline.apply_pipeline,glitchlab.gui.event_bus.EventBus,threading,dataclasses,typing
...
# DATA::SOURCES
img_u8: gui.widgets.image_canvas|gui.services.compositor
ctx: gui.state.State.snapshot|panel caller
steps: gui.preset_manager|presets/*.yaml|widgets.param_form

# DATA::SINKS
events: gui.event_bus (HUD,log_window,progress)
...
# glx:component=gui.services.pipeline_runner
